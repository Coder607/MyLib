...
protected:
    ...
    SharedPointer< Array< Edge<E> > > getUndirectedEdges()
    {
        ...
        {
            THROW_EXCEPTION(InvalidOperationException, "This function is for undirected gragh only...");
        }
    }
...
public:
    ...
    SharedPointer< Array< Edge<E> > > prim(const E& LIMIT, const bool MINIMUM = true)
    {
        ...
        {
            THROW_EXCEPTION(InvalidOperationException, "Prim operation is for undirected gragh only...");
        }
